...
export default {
  ...
  async created() {
    const storeUrl = `http://localhost:4000/v1/stores/${this.id}`; // Dynamic URL for store details
    const itemsUrl = `http://localhost:4000/v1/items?storeId=${this.id}`; // Filter items by store ID
